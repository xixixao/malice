...
"topLevel":function(){var x,xs;return this._or((function(){return (function(){x=this._or((function(){return (function(){this._many((function(){return this._apply("blankLine")}));return this._applyWithArgs("ometa",true)}).call(this)}),(function(){return this._apply("coffee")}));xs=this._many((function(){return this._or((function(){return this._applyWithArgs("ometa",false)}),(function(){return this._apply("coffee")}))}));return [x].concat(xs)}).call(this)}),(function(){return (function(){this._apply("end");return [['CoffeeScript', '']]}).call(this)}))}});

var coff = BSCoffeeScriptCompiler;
BSCoffeeScriptCompiler = {compile: function (source, options) {
  try {
    var result = coff.compile(source, options);
  } catch(e) {
    console.log(source);
    throw e;
  }
