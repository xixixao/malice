  ...
  define(function() {
    ...
    */
    ...
    isSequenceable = function(x) {
      return (x != null) && (typeof x === "string" || x.constructor === Array);
    };
    getTag = (function() {
      var numIdx;
      numIdx = 0;
    ...
    OMeta = (function() {
      ...
      OMeta.prototype._interleave = function(mode1, part1, mode2, part2) {
        var allDone, ans, arg, currInput, idx, _i, _len, _step;
        currInput = this.input;
        ans = [];
        for (idx = _i = 0, _len = arguments.length, _step = 2; _i < _len; idx = _i += _step) {
          arg = arguments[idx];
